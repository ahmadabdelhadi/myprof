...
{{-- 
            ...
            {{-- <div class="mt-4 ml-80">
                <x-jet-label for="address" value="{{ __('المراحل التي أُعلمها') }}" />
                <x-jet-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address')" required />
            </div> --}}
...
{{--             
            ...
            {{-- <div class="mt-4">
                <x-jet-label for="date" value="{{ __(': تاريخ الحجز') }}" />
                <x-jet-input id="date" class="block mt-1 w-full" type="date" name="date" required  />
                <x-jet-label for="time" value="{{ __(': موعد الحجز') }}" />
                <x-jet-input id="time" class="block mt-1 w-full" type="time" name="time" required  />
            </div> --}}
